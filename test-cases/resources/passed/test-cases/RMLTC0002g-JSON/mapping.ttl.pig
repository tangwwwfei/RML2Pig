...
%default TriplesMap1_source '{"iterator":"$.students[*]]","referenceFormulation":"ql:JSONPath","query":"","sqlVersion":"","tableName":"","name":"student2.json"}'
...
TriplesMap1_data = load 'student2.json' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["$.students[*]].ID,$.students[*]].Name"],["$.students[*]].IDs"]]') as (f1:tuple(chararray,chararray),f2:tuple(chararray));
