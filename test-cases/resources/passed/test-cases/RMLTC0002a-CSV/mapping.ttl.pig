...
TriplesMap1_data = load 'student.csv' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["ID,Name"],["ID"],["Name"]]') as (f1:tuple(chararray,chararray),f2:tuple(chararray),f3:tuple(chararray));
