...
map_map_data2_0_data = load 'data2.csv' using r2ps.udf.pig.R2PLOADSOURCE('${map_map_data2_0_source}','[["id"]]') as (f1:tuple(chararray));
...
map_map_data1_0_predicateObjectMap = cross child,parent;
