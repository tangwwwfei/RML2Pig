...
TriplesMap1_data = load 'student.xml' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["/students/student/ID,/students/student/Name"],["/students/student/Name"]]') as (f1:tuple(chararray,chararray),f2:tuple(chararray));
