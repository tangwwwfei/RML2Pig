...
%default TriplesMap1_source '{"iterator":"","referenceFormulation":"ql:CSV","query":"SELECT+Code%2C+Name%2C+Lan+FROM+Country+WHERE+Lan+%3D+%27EN%27%3B","sqlVersion":"rr:SQL2008","tableName":"","name":"","database":{"jdbcDSN":"CONNECTIONDSN","jdbcDriver":"com.mysql.cj.jdbc.Driver","username":"root","password":""}}'
...
%default TriplesMap2_source '{"iterator":"","referenceFormulation":"","query":"SELECT+%22Code%22%2C+%22Name%22%2C+%22Lan%22+FROM+%22Country%22+WHERE+%22Lan%22+%3D+%27ES%27%3B","sqlVersion":"rr:SQL2008","tableName":"","name":"","database":{"jdbcDSN":"CONNECTIONDSN","jdbcDriver":"com.mysql.cj.jdbc.Driver","username":"root","password":""}}'
