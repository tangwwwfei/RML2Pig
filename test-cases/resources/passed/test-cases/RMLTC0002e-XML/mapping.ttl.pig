...
%default TriplesMap1_source '{"iterator":"/students/student","referenceFormulation":"ql:XPath","query":"","sqlVersion":"","tableName":"","name":"student2.xml"}'
...
TriplesMap1_data = load 'student2.xml' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["/students/student/ID,/students/student/Name"],["/students/student/IDs"]]') as (f1:tuple(chararray,chararray),f2:tuple(chararray));
