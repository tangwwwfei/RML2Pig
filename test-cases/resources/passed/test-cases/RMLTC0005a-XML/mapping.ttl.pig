...
%default TriplesMap1_source '{"iterator":"/persons/person","referenceFormulation":"ql:XPath","query":"","sqlVersion":"","tableName":"","name":"ious.xml"}'
...
TriplesMap1_data = load 'ious.xml' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["/persons/person/fname,/persons/person/lname"],["/persons/person/amount"]]') as (f1:tuple(chararray,chararray),f2:tuple(chararray));
