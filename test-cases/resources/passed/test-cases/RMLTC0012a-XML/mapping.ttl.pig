...
TriplesMap1_data = load 'persons.xml' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["/Persons/Person/fname,/Persons/Person/lname,/Persons/Person/amount"],["/Persons/Person/fname,/Persons/Person/lname"],["/Persons/Person/amount"]]') as (f1:tuple(chararray,chararray,chararray),f2:tuple(chararray,chararray),f3:tuple(chararray));
