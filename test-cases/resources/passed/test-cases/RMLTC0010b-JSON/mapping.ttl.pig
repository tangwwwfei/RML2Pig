...
TriplesMap1_data = load 'country_info.json' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["$.countries[*].@[\'Country Code\'],$.countries[*].Name"],["$.countries[*].Name"]]') as (f1:tuple(chararray,chararray),f2:tuple(chararray));
