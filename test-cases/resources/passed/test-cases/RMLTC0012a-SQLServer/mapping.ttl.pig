...
TriplesMap1_data = load 'UnusedPath' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["fname,lname,amount"],["fname,lname"],["amount"]]') as (f1:tuple(chararray,chararray,chararray),f2:tuple(chararray,chararray),f3:tuple(chararray));
