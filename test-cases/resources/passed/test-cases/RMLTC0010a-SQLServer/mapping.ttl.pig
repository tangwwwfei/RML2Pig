...
%default TriplesMap1_template '<http://example.com/{Country Code}>'

TriplesMap1_data = load 'UnusedPath' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["Country Code"],["Name"]]') as (f1:tuple(chararray),f2:tuple(chararray));
