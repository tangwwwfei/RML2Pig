...
%default TriplesMap1_template '_:students{ID}'

TriplesMap1_data = load 'UnusedPath' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["ID"],["Name"]]') as (f1:tuple(chararray),f2:tuple(chararray));
