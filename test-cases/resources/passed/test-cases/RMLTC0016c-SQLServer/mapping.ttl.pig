...
TriplesMap1_data = load 'UnusedPath' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["ID"],["BirthDate"],["EntranceDate"]]') as (f1:tuple(chararray),f2:tuple(chararray),f3:tuple(chararray));
