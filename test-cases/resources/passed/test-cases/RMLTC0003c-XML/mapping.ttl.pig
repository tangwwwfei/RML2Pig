...
TriplesMap1_data = load 'student.xml' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["/students/student/ID"],["/students/student/FirstName,/students/student/LastName"]]') as (f1:tuple(chararray),f2:tuple(chararray,chararray));
