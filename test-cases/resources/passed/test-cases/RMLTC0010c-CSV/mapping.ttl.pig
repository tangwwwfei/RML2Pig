...
%default TriplesMap1_source '{"iterator":"","referenceFormulation":"ql:CSV","query":"","sqlVersion":"","tableName":"","name":"country_info.csv"}'
...
TriplesMap1_data = load 'country_info.csv' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["Country Code,Name"],["ISO 3166"]]') as (f1:tuple(chararray,chararray),f2:tuple(chararray));
