...
%default TriplesMap1_source '{"iterator":"$","referenceFormulation":"ql:JSONPath","query":"","sqlVersion":"","tableName":"","name":"data.json"}'
...
TriplesMap1_data = load 'data.json' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["$.id"],["$.values[*]"]]') as (f1:tuple(chararray),f2:tuple(chararray));
