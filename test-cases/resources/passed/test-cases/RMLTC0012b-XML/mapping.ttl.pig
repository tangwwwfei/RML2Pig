...
TriplesMap1_data = load 'persons.xml' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["/Persons/Person/fname,/Persons/Person/lname"]]') as (f1:tuple(chararray,chararray));
...
TriplesMap2_data = load 'lives.xml' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap2_source}','[["/Lives/Live/fname,/Lives/Live/lname"],["/Lives/Live/city"]]') as (f1:tuple(chararray,chararray),f2:tuple(chararray));
