...
TriplesMap1_data = load 'student.json' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["$.students[*].ID"],["$.students[*].FirstName,$.students[*].LastName"]]') as (f1:tuple(chararray),f2:tuple(chararray,chararray));
