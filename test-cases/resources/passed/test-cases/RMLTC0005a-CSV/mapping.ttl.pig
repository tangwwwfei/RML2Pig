...
%default TriplesMap1_source '{"iterator":"","referenceFormulation":"ql:CSV","query":"","sqlVersion":"","tableName":"","name":"ious.csv"}'
...
TriplesMap1_data = load 'ious.csv' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["fname,lname"],["amount"]]') as (f1:tuple(chararray,chararray),f2:tuple(chararray));
