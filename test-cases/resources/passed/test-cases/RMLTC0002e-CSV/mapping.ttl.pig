...
%default TriplesMap1_source '{"iterator":"","referenceFormulation":"ql:CSV","query":"","sqlVersion":"","tableName":"","name":"student2.csv"}'
...
TriplesMap1_data = load 'student2.csv' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["ID,Name"],["IDs"]]') as (f1:tuple(chararray,chararray),f2:tuple(chararray));
