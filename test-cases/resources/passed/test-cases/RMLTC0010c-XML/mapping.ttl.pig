...
%default TriplesMap1_source '{"iterator":"/countries/country","referenceFormulation":"ql:XPath","query":"","sqlVersion":"","tableName":"","name":"country_info.xml"}'

%default TriplesMap1_referenceFormulation 'ql:XPath'

%default TriplesMap1_iterator '/countries/country'

%default TriplesMap1_template '<http://example.com/{CountryCode}/{Name}>'

TriplesMap1_data = load 'country_info.xml' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["/countries/country/CountryCode,/countries/country/Name"],["/countries/country/ISO3166"]]') as (f1:tuple(chararray,chararray),f2:tuple(chararray));
