...
TriplesMap1_data = load 'UnusedPath' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["ID,FirstName"],["Name"]]') as (f1:tuple(chararray,chararray),f2:tuple(chararray));
