...
TriplesMap1_data = load 'student.json' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["$.students[*].ID,$.students[*].Name"],["$.students[*].ID"],["$.students[*].Name"]]') as (f1:tuple(chararray,chararray),f2:tuple(chararray),f3:tuple(chararray));
