...
%default TriplesMap1_source '{"iterator":"","referenceFormulation":"ql:CSV","query":"","sqlVersion":"","tableName":"","name":"country_en.csv"}'
...
TriplesMap1_data = load 'country_en.csv' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["Code"],["Name"]]') as (f1:tuple(chararray),f2:tuple(chararray));
...
%default TriplesMap2_source '{"iterator":"","referenceFormulation":"ql:CSV","query":"","sqlVersion":"","tableName":"","name":"country_es.csv"}'
...
TriplesMap2_data = load 'country_es.csv' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap2_source}','[["Code"],["Name"]]') as (f1:tuple(chararray),f2:tuple(chararray));
