...
%default TriplesMap1_source '{"iterator":"","referenceFormulation":"ql:CSV","query":"","sqlVersion":"","tableName":"","name":"https://rml.io/docs/rml/data-retrieval/dcat/Airport.csv"}'
...
TriplesMap1_data = load 'https://rml.io/docs/rml/data-retrieval/dcat/Airport.csv' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["id"],["city"]]') as (f1:tuple(chararray),f2:tuple(chararray));
