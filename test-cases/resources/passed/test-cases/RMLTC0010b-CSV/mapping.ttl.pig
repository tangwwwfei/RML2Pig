...
TriplesMap1_data = load 'country_info.csv' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["Country Code,Name"],["Name"]]') as (f1:tuple(chararray,chararray),f2:tuple(chararray));
