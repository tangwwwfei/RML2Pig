...
%default TriplesMap1_source '{"iterator":"","referenceFormulation":"ql:CSV","query":"","sqlVersion":"","tableName":"","name":"persons.csv"}'
...
TriplesMap1_data = load 'persons.csv' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["fname,lname"]]') as (f1:tuple(chararray,chararray));

TriplesMap1_table = foreach TriplesMap1_data generate 
	R2PFORMAT('${TriplesMap1_template}', $0),
	$0;

%default TriplesMap2_source '{"iterator":"","referenceFormulation":"ql:CSV","query":"","sqlVersion":"","tableName":"","name":"lives.csv"}'
...
TriplesMap2_data = load 'lives.csv' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap2_source}','[["fname,lname"],["city"]]') as (f1:tuple(chararray,chararray),f2:tuple(chararray));
