...
TriplesMap1_data = load 'country_info.xml' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["/countries/country/CountryCode,/countries/country/Name"],["/countries/country/Name"]]') as (f1:tuple(chararray,chararray),f2:tuple(chararray));
