...
%default TriplesMap1_source '{"iterator":"$.countries[*]","referenceFormulation":"ql:JSONPath","query":"","sqlVersion":"","tableName":"","name":"country_info.json"}'
...
TriplesMap1_data = load 'country_info.json' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["$.countries[*].@[\'Country Code\'],$.countries[*].Name"],["$.countries[*].@[\'ISO 3166\']"]]') as (f1:tuple(chararray,chararray),f2:tuple(chararray));
