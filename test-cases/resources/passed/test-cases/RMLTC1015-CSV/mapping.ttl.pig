...
%default TriplesMap1_template '<http://example.com/\u03B8\u03B5\u03C1\u03BC\u03CC\u03C4\u03B7\u03C4\u03B1/{ID}>'

TriplesMap1_data = load 'student.csv' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["ID"],["Name"]]') as (f1:tuple(chararray),f2:tuple(chararray));
