...
%default TriplesMap2_source '{"iterator":"$.countries[*]","referenceFormulation":"ql:JSONPath","query":"","sqlVersion":"","tableName":"","name":"country_en.json"}'
...
TriplesMap2_data = load 'country_en.json' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap2_source}','[["$.countries[*].Code"],["$.countries[*].Name"]]') as (f1:tuple(chararray),f2:tuple(chararray));
