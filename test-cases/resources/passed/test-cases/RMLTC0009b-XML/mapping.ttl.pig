...
TriplesMap1_data = load 'student.xml' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["/students/student/ID"],["/students/student/Name"],["/students/student/Sport"]]') as (f1:tuple(chararray),f2:tuple(chararray),f3:tuple(chararray));
...
TriplesMap2_data = load 'sport.xml' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap2_source}','[["/sports/sport/ID"],["/sports/sport/Name"]]') as (f1:tuple(chararray),f2:tuple(chararray));
