...
%default TriplesMap2_source '{"iterator":"/students/student","referenceFormulation":"ql:XPath","query":"","sqlVersion":"","tableName":"","name":"student.xml"}'
...
TriplesMap2_data = load 'student.xml' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap2_source}','[["/students/student/Sport"]]') as (f1:tuple(chararray));
...
TriplesMap1_data = load 'student.xml' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["/students/student/ID,/students/student/Name"],["/students/student/ID"],["/students/student/Name"],["/students/student/Sport"]]') as (f1:tuple(chararray,chararray),f2:tuple(chararray),f3:tuple(chararray),f4:tuple(chararray));
