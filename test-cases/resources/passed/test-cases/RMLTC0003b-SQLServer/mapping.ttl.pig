...
%default TriplesMap1_source '{"iterator":"","referenceFormulation":"","query":"SELECT+ID%2C+LastName%2C+concat_ws%28FirstName%2C+%27%27%2C+LastName%29+as+Name+FROM+student","sqlVersion":"rr:SQL2008","tableName":"student","name":"","database":{"jdbcDSN":"CONNECTIONDSN","jdbcDriver":"com.microsoft.sqlserver.jdbc.SQLServerDriver","username":"sa","password":"YourSTRONG!Passw0rd;"}}'
