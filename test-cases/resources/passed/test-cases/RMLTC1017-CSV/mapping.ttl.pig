...
%default TriplesMap1_source '{"iterator":"","referenceFormulation":"ql:CSV","query":"","sqlVersion":"","tableName":"","name":"input.csv"}'
...
TriplesMap1_data = load 'input.csv' using r2ps.udf.pig.R2PLOADSOURCE('${TriplesMap1_source}','[["id"],["bn"]]') as (f1:tuple(chararray),f2:tuple(chararray));
