...
object persons_xml extends App {
  ...
  val PersonMapping_source = """{"iterator":"/persons/person","referenceFormulation":"ql:XPath","query":"","sqlVersion":"","tableName":"","name":""""+args(0)+"\"}"

  val PersonMapping_referenceFormulation = """ql:XPath"""

  val PersonMapping_iterator = """/persons/person"""

  val PersonMapping_template = """<http://example.org/person/{id}{name}>"""

  var PersonMapping_data = R2PLOADSOURCE(PersonMapping_source,"""[["/persons/person/id,/persons/person/name"],["/persons/person/name"],["/persons/person/email"],["/persons/person/phone"],["/persons/person/birthdate"],["/persons/person/height"],["/persons/person/weight"]]""")
