...
--<#LocationMapping_JSON>
    ...
    --<LogicalSource End>
    --<subjectMap>
    LocationMapping_JSON_subjectMaps = foreach LocationMapping_JSON_data generate FLATTEN(extractJson(cont,'$.venue[*].latitude', '$.venue[*].longitude')) as subject,cont;
...
--<#TransportMapping>
    ...
    --<LogicalSource End>
    --<subjectMap>
    TransportMapping_subjectMaps = foreach TransportMapping_data generate FLATTEN(extractXML(cont,'${TransportMapping_iterator}/@id')) as subject,FORMAT('${rdf}','type') as predicate,FORMAT('${ex}','Transport') as object,cont;
    TransportMapping_subjectMaps = foreach TransportMapping_subjectMaps generate FLATTEN($0) as subject, FLATTEN($1) as predicate, FLATTEN($2) as object, $3 as cont;
    TransportMapping_subjectMaps_fullname = foreach TransportMapping_subjectMaps generate FORMAT('${TransportMapping_template}',subject) as subject, predicate as predicate, object as object;
